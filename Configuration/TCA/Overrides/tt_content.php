...
call_user_func(function($namespace, $extkey) {
  ...
  $contentElementName      = strtolower('Products');
  ...
  \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue($contentElementSignature, 'FILE:EXT:' . $extkey . '/Configuration/FlexForms/ContentElements/ProductsContentElement.xml');
