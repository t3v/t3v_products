<?php
namespace T3v\T3vProducts\Tests\Functional;
 ...
 *
 * @package T3v\T3vProducts\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
   ...
   * @var array
   */
  protected $testExtensionsToLoad = ['typo3conf/ext/t3v_products'];
  ...
  public function templateIsRendered() {
    ...
    $expectedDom->loadHTML('<h1>T3v Products</h1>');
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_products/Tests/Functional/Fixtures/Frontend/Basic.ts']);
  }
